...
public class MyFragment extends Fragment {
    ...
    private void findView() {
        ...
        mBtn_sqrt=(Button) view.findViewById(R.id.btn_sqrt);
        ...
        mBtn_sqrt.setOnClickListener(btn_OnClick);
    }
            ...
            if (mStr_display != null) {
                ...
                switch (v.getId()) {
                    ...
                    case R.id.btn_calc_add:// 符号键"+"单击事件
                        if(mStr_display.length()==0){
                            Toast.makeText(getActivity(),"不能直接输入算术符",Toast.LENGTH_SHORT).show();
                            break;
                        }
                        mStr_result = "";
                        //if(mStr_display.toString().equals("无穷大") || mStr_display.toString().equals("负无穷")){
                        //    Toast.makeText(getActivity(),"不可以这样做",Toast.LENGTH_SHORT).show();
                         //   break;
                        //}
                        // 判断是否是以"/0"结尾的
                        if (mStr_display.toString().endsWith("/0")) {
                            ...
                            if (mStr_display.toString().indexOf("+") != -1
                                ...
                                if (mStr_display.toString().charAt(
                                    ...
                                    if(flag==1){
                                        ...
                                        mStr_display.delete(0,mStr_display.length());
                                        flag=0;
                                    }
                                }
                            }
                    ...
                    case R.id.btn_sqrt:   //开方
                        if(mStr_display.toString().indexOf("-") == -1){
                            try{
                                mValue=Double.parseDouble(CalcTool.kaifang(mStr_display
                                        .toString()));
                                if (mValue >= Float.MAX_VALUE) {
                                    mStr_display.append("无穷大");
                                } else if (mValue <= -Float.MAX_VALUE) {
